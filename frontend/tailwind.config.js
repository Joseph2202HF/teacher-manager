  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        muted:   '#2d3748',
        // Accent néon
        cyan:    { DEFAULT: '#00f0ff', 50: '#e6feff', 100: '#ccfdff', 200: '#99fbff', 300: '#66f8ff', 400: '#33f4ff', 500: '#00f0ff', 600: '#00c0cc', 700: '#009099', 800: '#006066', 900: '#003033' },
        indigo:  { DEFAULT: '#818cf8', 50: '#eef2ff', 100: '#e0e7ff', 200: '#c7d2fe', 300: '#a5b4fc', 400: '#818cf8', 500: '#6366f1', 600: '#4f46e5', 700: '#4338ca', 800: '#3730a3', 900: '#312e81' },
        emerald: { DEFAULT: '#34d399', 50: '#ecfdf5', 100: '#d1fae5', 200: '#a7f3d0', 300: '#6ee7b7', 400: '#34d399', 500: '#10b981', 600: '#059669', 700: '#047857', 800: '#065f46', 900: '#064e3b' },
        rose:    { DEFAULT: '#fb7185', 50: '#fff1f2', 100: '#ffe4e6', 200: '#fecdd3', 300: '#fda4af', 400: '#fb7185', 500: '#f43f5e', 600: '#e11d48', 700: '#be123c', 800: '#9f1239', 900: '#881337' },
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'linear-gradient(135deg, #0a0d12 0%, #12161f 50%, #181d2a 100%)',
        ...
        // Patterns
        'grid-pattern': "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' stroke='%231f2737' stroke-width='0.5'%3E%3Cpath d='M0 0h60v60H0z'/%3E%3C/g%3E%3C/svg%3E\")",
        'dot-pattern': "url(\"data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='1' cy='1' r='1' fill='%231f2737'/%3E%3C/svg%3E\")",
      ...
      boxShadow: {
        ...
        'elevation-4': '0 15px 40px rgba(0, 0, 0, 0.5), 0 5px 15px rgba(0, 0, 0, 0.3)',
        // Glass effect
